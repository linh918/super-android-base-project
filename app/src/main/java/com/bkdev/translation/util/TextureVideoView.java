...
public class TextureVideoView extends TextureView
    ...
    private void clearSurface() {
        if (mSurfaceTexture == null || Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
            return;
        }
        ...
        EGLSurface eglSurface = egl.eglCreateWindowSurface(display, config, mSurfaceTexture, new int[]{
                EGL10.EGL_NONE
        });
    ...
    private void openVideo() {
        Log.d("getSurfaceTexture", " -- openVideo -- " +
                getSurfaceTexture() + " -- " + mSurfaceTexture + " -- " + mUri);
...
//                    }
    ...
    TextureView.SurfaceTextureListener mSurfaceTextureListener = new SurfaceTextureListener() {
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
            Log.d("getSurfaceTexture", " -- onSurfaceTextureAvailable -- " +
    ...
    private void release(boolean clearTargetState) {
        try {
            ...
            Log.v(TAG, "Release media player : " + ex.getMessage());
        }
    }
    ...
    @Override
    public void start() {
        Log.d("getSurfaceTexture", " -- start -- " + isInPlaybackState());
    ...
    @Override
    public void pause() {
        Log.d("getSurfaceTexture", " -- pause -- " + isInPlaybackState());
        if (isInPlaybackState()) {
            if (mMediaPlayer.isPlaying()) {
                mMediaPlayer.pause();
    ...
    public void seekTo(int sec) {
        Log.d("getSurfaceTexture", " -- seekTo -- " + isInPlaybackState());
        if (isInPlaybackState()) {
    ...
    private boolean isInPlaybackState() {
        ...
        Log.d("getSurfaceTexture", " -- isInPlaybackState -- " + mMediaPlayer + " -- " + mCurrentState);
