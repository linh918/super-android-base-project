 ...
 * At 16:09
 */
public class OnVideoControllerView extends FrameLayout implements OnVideoGestureListener {
    ...
    public OnVideoControllerView(Builder builder) {
    ...
    public static class Builder {
        ...
        public OnVideoControllerView build(@Nullable ViewGroup anchorView) {
            this.anchorView = anchorView;
            return new OnVideoControllerView(this);
        }
    ...
    private static class ControllerViewHandler extends Handler {
        private final WeakReference<OnVideoControllerView> mView;

        ControllerViewHandler(OnVideoControllerView view) {
            mView = new WeakReference<>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            OnVideoControllerView view = mView.get();
     ...
     *
     * @return the root view of {@link OnVideoControllerView}
     */
    ...
    /**
     * find all views inside {@link OnVideoControllerView}
     * and init params
     */
    ...
    private void show() {
        ...
        if (!mIsShowing && mAnchorView != null) {
            ...
            mAnchorView.addView(OnVideoControllerView.this, tlp);
    ...
    /**
     * toggle {@link OnVideoControllerView} show or not
    ...
    /**
     * if {@link OnVideoControllerView} is visible
     *
    ...
    private void hide() {
        ...
        ViewAnimator.putOn(mTopLayout)
                ...
                .end(new ViewAnimator.Listeners.End() {
                    @Override
                    public void onEnd() {
                        mAnchorView.removeView(OnVideoControllerView.this);
