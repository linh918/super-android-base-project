 ...
 * At 16:09
 */
public class MyOnVideoController extends FrameLayout implements OnVideoGestureListener {

    private static final String TAG = "OnVideoControllerView";
    ...
    private CustomTextureVideoView mVideoView;
    ...
    public MyOnVideoController(Builder builder) {
    ...
    public static class Builder {
        ...
        private CustomTextureVideoView videoView;
        @DrawableRes
        ...
        public Builder withVideoView(@Nullable CustomTextureVideoView customTextureVideoView) {
            this.videoView = customTextureVideoView;
            return this;
        }
        ...
        public Builder exitView(@DrawableRes int exitIcon) {
            this.exitIcon = exitIcon;
            return this;
        }

        public Builder pauseView(@DrawableRes int pauseIcon) {
            this.pauseIcon = pauseIcon;
            return this;
        }

        public Builder playView(ImageButton playButton,@DrawableRes int playIcon) {
            this.playIcon = playIcon;
            return this;
        }

        public Builder shrinkView(@DrawableRes int shrinkIcon) {
            this.shrinkIcon = shrinkIcon;
            return this;
        }

        public Builder stretchView(@DrawableRes int stretchIcon) {
            this.stretchIcon = stretchIcon;
            return this;
        }
        ...
        public MyOnVideoController build(@Nullable ViewGroup anchorView) {
            this.anchorView = anchorView;
            return new MyOnVideoController(this);
        }
    ...
    private static class ControllerViewHandler extends Handler {
        private final WeakReference<MyOnVideoController> mView;

        ControllerViewHandler(MyOnVideoController view) {
            mView = new WeakReference<>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            MyOnVideoController view = mView.get();
     ...
     *
     * @return the root view of {@link MyOnVideoController}
     */
    ...
    /**
     * find all views inside {@link MyOnVideoController}
     * and init params
     */
    ...
    private void show() {
        ...
        if (!mIsShowing && mAnchorView != null) {
            ...
            mAnchorView.addView(MyOnVideoController.this, tlp);
    ...
    /**
     * toggle {@link MyOnVideoController} show or not
    ...
    /**
     * if {@link MyOnVideoController} is visible
     *
    ...
    private void hide() {
        ...
        ViewAnimator.putOn(mTopLayout)
                ...
                .end(new ViewAnimator.Listeners.End() {
                    @Override
                    public void onEnd() {
                        mAnchorView.removeView(MyOnVideoController.this);
