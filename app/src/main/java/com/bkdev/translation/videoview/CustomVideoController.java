 ...
 *
 */
public class CustomVideoController extends FrameLayout implements OnVideoGestureListener {
    ...
    public CustomVideoController(Builder builder) {
    ...
    public static class Builder {
        ...
        public CustomVideoController build(@Nullable ViewGroup anchorView) {
            this.anchorView = anchorView;
            return new CustomVideoController(this);
        }
    ...
    private static class ControllerViewHandler extends Handler {
        private final WeakReference<CustomVideoController> mView;

        ControllerViewHandler(CustomVideoController view) {
            mView = new WeakReference<>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            CustomVideoController view = mView.get();
     ...
     *
     * @return the root view of {@link CustomVideoController}
     */
    ...
    /**
     * find all views inside {@link CustomVideoController}
     * and init params
     */
    private void initControllerView() {
        ...
        if (mSeekBar != null) {
            mSeekBar.getProgressDrawable().setColorFilter(Color.LTGRAY, PorterDuff.Mode.MULTIPLY);
    ...
    private void show() {
        ...
        if (!mIsShowing && mAnchorView != null) {
            ...
            mAnchorView.addView(CustomVideoController.this, tlp);
    ...
    /**
     * toggle {@link CustomVideoController} show or not
    ...
    /**
     * if {@link CustomVideoController} is visible
     *
    ...
    private void hide() {
        ...
        ViewAnimator.putOn(mTopLayout)
                ...
                .end(new ViewAnimator.Listeners.End() {
                    @Override
                    public void onEnd() {
                        mAnchorView.removeView(CustomVideoController.this);
